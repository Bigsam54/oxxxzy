...
import { CheckCircle2, ArrowRight, Zap, Calendar, Monitor } from 'lucide-react';
      ...
      <main>
        ...
        >
          <div
            ...
            style={{ opacity: 0.96, background: 'linear-gradient(135deg, var(--theme-bg), #0a0a0a)' }}
          ></div>
          <div
          ...
          >
            <div className="fade-up" style={{ textAlign: 'left' }}>
              ...
              >
                Two days that
                <br />
                <span style={{ color: 'var(--ghana-gold)', fontStyle: 'italic' }}>change</span> everything.
              </h1>
          ...
          <div className="container container--sm" style={{ margin: '0', textAlign: 'left' }}>
            <div style={{ textAlign: 'left', marginBottom: '48px' }} className="fade-up">
              ...
              <h2 className="text-dark" style={{ textAlign: 'left' }}>
                Secure Your Session Spot
              </h2>
              <p className="text-muted-dark" style={{ fontSize: '18px' }}>
                Join the largest virtual gathering of young Ghanaian builders.
              </p>
            </div>
            ...
            {isSubmitted ? (
              ...
              >
                <div style={{ color: 'var(--ghana-green)', marginBottom: '20px' }}>
                  <CheckCircle2 size={48} />
                </div>
                <h3
                  className="text-dark"
                  style={{ fontFamily: 'var(--font-head)', fontSize: '32px', fontWeight: 700, marginBottom: '16px' }}
                >
                  You&apos;re Officially Registered!
                </h3>
                <p className="text-muted-dark" style={{ fontSize: '18px' }}>
                  Thank you for joining YES 2026. We&apos;ve sent a confirmation email to your address with access
                  details and preparatory materials.
                </p>
              </div>
            ) : (
              <div
          ...
          <div className="container" style={{ textAlign: 'left' }}>
            <div className="fade-up" style={{ textAlign: 'left' }}>
              ...
              <p className="text-muted-dark" style={{ maxWidth: '600px', margin: '0 0 40px', fontSize: '18px' }}>
                Join the Entrepreneurs Club today for immediate access to our private network, monthly masterclasses,
                and peer accountability groups.
              </p>
              <Link
                href="/club"
                className="btn btn-outline btn-lg"
                style={{ borderColor: 'var(--theme-bg)', color: 'var(--theme-bg)' }}
              >
